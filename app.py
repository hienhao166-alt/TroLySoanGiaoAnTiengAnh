...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Thu Hiền - Trường Tiểu học Ngọc Đường - ĐT: 0915503130</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thu Hiền - Trường Tiểu học Ngọc Đường - ĐT: 0915503130</div>", unsafe_allow_html=True)
